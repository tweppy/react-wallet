  ...
  return (
    <>
      <header className='card-top'>
        { removeCard ? <button className='del-btn' onClick={() => handleRemove(cardData)}>DELETE</button> : null }
      </header>

      <article className='card'
        style={ {backgroundColor: cardData.backgroundColor, color: cardData.color} }
        onClick={ !preventClick ? () => handleActiveCard(cardData) : null }>
